...
export const csEvents: Event[] = [
  ...
  },
  {
    ...
    description: "Prize Pool: ₹1500! An exciting coding competition designed to test your problem-solving skills, programming logic, coding speed, and algorithmic thinking. Activity Points Available & Certificates for all participants.",
    ...
    societyId: "cs",
    status: "past",
    registrationUrl: "https://docs.google.com/forms/d/e/1FAIpQLSc862T8XmeoH2OqE7g9YYRBSIM7EZkmnGJpauftjux4GMMMXA/viewform?usp=header",
